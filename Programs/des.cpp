...
unsigned long long encrypt(unsigned long long input, int round) {
	...
	fOutput = temp;
	if(round == 16) {
		cout << "Plaintext after round " << dec << round << endl;
 		cout <<  hex << (left << 32 | fOutput);
		cout << endl;
...
/*
Key is: aabb091cca90ccdd
For Round 1 a00755b0c2791f
For Round 2 400eab7184f23e
For Round 3 3aadd613c8f8
...
After initial permutation ca18ad0c14a7d678
...
c623f35e7b5d94e7
Plaintext after round 11
367c6248c623f35e
Plaintext after round 12
c623f35e367c6248
Plaintext after round 13
c2508626c623f35e
Plaintext after round 14
c623f35ec2508626
Plaintext after round 15
7b5d94e7c623f35e
Plaintext after round 16
7b5d94e7c623f35e
After encryption 7b5d94e7c623f35e
After final permutation 3579eb97525e69db
*/